...
function update() {
    ...
    Context.fillRect(powX, powY, blocksize, blocksize);
...
function placepowerup() {
    powX = Math.floor(Math.random() * columns) * blocksize;
    powY = Math.floor(Math.random() * rows) * blocksize;
}
