...
function update() {
    ...
    Context.fillRect(mineX, mineY, blocksize, blocksize-1);
...
function placemine() {
    mineX = Math.floor(Math.random() * columns) * blocksize;
    mineY = Math.floor(Math.random() * rows) * blocksize;
}
